...
export function AdminMembersPage() {
  ...
  useEffect(load, [slug]);
  if (loadError) return <Layout signedIn><h1>Member administration</h1><p role="alert" tabIndex={-1} className="error-summary">{loadError} <Link to={`/p/${slug}/overview`}>Return to the pool home</Link>.</p></Layout>;
