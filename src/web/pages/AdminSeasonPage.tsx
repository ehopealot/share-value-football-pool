...
export function AdminSeasonPage() {
  ...
  if (loadError) return <Layout signedIn><h1>Season administration</h1><p ref={errorRef} role="alert" tabIndex={-1} className="error-summary">{loadError} <Link to={`/p/${slug}/overview`}>Return to the pool home</Link>.</p></Layout>;
