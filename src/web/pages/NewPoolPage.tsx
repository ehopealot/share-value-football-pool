...
export function NewPoolPage() {
  const nav = useNavigate(); const turnstileTarget = useRef<HTMLDivElement>(null); const [authorized, setAuthorized] = useState<boolean>(); const [error, setError] = useState(""); const [pending, setPending] = useState(false); const commandId = useRef(crypto.randomUUID());
