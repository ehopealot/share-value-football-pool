...
export function ParlayPage() {
  ...
  const place = async () => {
    ...
    try {
      ...
      else { setState(parlayUnresolvedPlacementTransition(attempt)); setError("Placement result unknown. Retry this exact placement to check its result."); }
    }
  };
  if (reviewed) {
