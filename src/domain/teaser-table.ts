...
/** Settlement reprices from the table the ticket's stored ruleset accepted; unknown rulesets fail closed to refunds. */
...
export function isSupportedTeaserRuleset(rulesetVersion: string): boolean {
  return rulesetVersion === TEASER_RULESET_ID || rulesetVersion === LEGACY_TEASER_RULESET_ID;
}
