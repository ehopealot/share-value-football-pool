...
- Teasers support 6, 6.5, 7, 7.5, and 10 points under one system-wide ruleset with 2–6 legs; 10-point teasers require exactly three legs. Teasers may mix NFL/NCAA sides and totals; moneylines are ineligible. During testing the operator repriced the table in place under the unchanged ruleset ID (no teaser tickets existed at the time); after launch, teaser repricings ship under a new ruleset ID so accepted terms stay accepted.
- Betting weeks remain Tuesday–Monday, ending Monday night at midnight Pacific Time. New quotes and wagers open Tuesday at 10:00 a.m. Pacific Time; no new betting is accepted during the ten-hour gap. Pacific daylight-saving time is observed. Previously accepted quotes and placement results remain replayable, but replaying a quote does not bypass the placement window.
