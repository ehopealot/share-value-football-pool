...
- Betting weeks remain Tuesday–Monday, ending Monday night at midnight Eastern Time. New quotes and wagers open Tuesday at 10:00 a.m. Eastern Time; no new betting is accepted during the ten-hour gap. Eastern daylight-saving time is observed. Previously accepted quotes and placement results remain replayable, but replaying a quote does not bypass the placement window.
