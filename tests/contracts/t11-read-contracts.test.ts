...
describe("T11 member read contracts", () => {
  ...
  it("requires the immutable ruleset version in every pool lifecycle summary", () => {
    ...
    const view = { commandVersion: "1", pool: { poolId: "p", slug: "pool", name: "Pool", commissionerId: "owner", signupsOpen: true, maxSideBetMicros: "800000000" }, activeSeason: summary, nextDraftSeason: null, latestClosedSeason: null, currentMember: { memberId: "owner", role: "commissioner", seasonBalances: [{ seasonId: "s", availableMicros: "0", lockedMicros: "0" }], hasUnreadBoard: false }, members: [{ memberId: "owner", displayName: "Owner", role: "commissioner", status: "active" }], commissioner: { seasonOrders: [] } };
