...
describe("immutable confirmation protocol", () => {
  ...
  it("builds placement from frozen authority only and rejects malformed success", () => {
    ...
    const expectedTeaserPlacement = {
      ...
      seasonId: "season-1", riskMicros: "1000000", acceptedOdds: 165, teaserPoints: 6, rulesetVersion: "TEASER_2026_V2", legs: teaserQuote.legs
    };
  ...
  it("renders straight, teaser, and order confirmations from snapshots without editor data", () => {
    ...
    const teaserQuote = teaserWagerQuoteSnapshot.parse({
      quoteKey: "teaser", seasonId: "season", ownerMemberId: "owner", riskMicros: "1000000", acceptedOdds: 165, teaserPoints: 6, rulesetVersion: "TEASER_2026_V2", commandVersion: "1",
  ...
  it("requires canonical null moneyline lines and strict teaser direction/count", () => {
    ...
    const teaserRequest: z.infer<typeof teaserWagerQuoteRequest> = { quoteKey: "quote-teaser", commandId: "quote-teaser", wagerId: "wager-teaser", seasonId: "season-1", riskMicros: "1000000", teaserPoints: 10, rulesetVersion: "TEASER_2026_V2", legs: teaser.legs.map(({ eventId, canonicalBook, market, selection, canonicalOfferProof, offerVersion }) => ({ eventId, canonicalBook, market, selection, offerId: canonicalOfferProof.offerId, offerVersion })) };
    const teaserSnapshot = { quoteKey: "quote-teaser", seasonId: "season-1", ownerMemberId: "owner", riskMicros: "1000000", acceptedOdds: -110, teaserPoints: 10, rulesetVersion: "TEASER_2026_V2", commandVersion: "12", legs: teaser.legs };
