...
describe("immutable confirmation protocol", () => {
  ...
  it("builds placement from frozen authority only and rejects malformed success", () => {
    ...
    const expectedTeaserPlacement = {
      ...
      seasonId: "season-1", riskMicros: "1000000", acceptedOdds: 165, teaserPoints: 6, rulesetVersion: "SHARE_POOL_2026_V1", legs: teaserQuote.legs
    };
  ...
  it("renders straight, teaser, and order confirmations from snapshots without editor data", () => {
    ...
    const teaserQuote = teaserWagerQuoteSnapshot.parse({
      quoteKey: "teaser", seasonId: "season", ownerMemberId: "owner", riskMicros: "1000000", acceptedOdds: 165, teaserPoints: 6, rulesetVersion: "SHARE_POOL_2026_V1", commandVersion: "1",
  ...
  it("requires canonical null moneyline lines and strict teaser direction/count", () => {
    ...
    const teaserSnapshot = { quoteKey: "quote-teaser", seasonId: "season-1", ownerMemberId: "owner", riskMicros: "1000000", acceptedOdds: -110, teaserPoints: 10, rulesetVersion: "SHARE_POOL_2026_V1", commandVersion: "12", legs: teaser.legs };
