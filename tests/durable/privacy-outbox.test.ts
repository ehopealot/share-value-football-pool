...
describe("PoolDO privacy and committed outbox", () => {
  ...
  it("reveals only started teaser legs to nonowners", async () => {
    ...
    await send(slug, { type: "PlaceTeaserWager", commandId: "mixed-teaser", actorId: "member", wagerId: "mixed", seasonId: "s1", riskMicros: "1000000", acceptedOdds: -110, teaserPoints: 6, rulesetVersion: "TEASER_2026_V2", legs: [teaserLeg("started-leg", -6), teaserLeg("future-leg", -3)] });
