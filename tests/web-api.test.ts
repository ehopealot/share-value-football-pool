...
describe("wager recovery messages", () => {
  ...
  it("preserves exact owner wager fields while parsing a time-redacted audit export", () => {
    const exported = {
      ...
      wagers: [{ wagerId: "w", seasonId: "s", memberId: "member", memberDisplayName: "Member", type: "teaser", status: "open", confirmedAt: "2026-01-01T00:00:00.000Z", riskMicros: "900719925474099312345678", acceptedOdds: -120, rulesetVersion: "SHARE_POOL_2026_V1", legs: [{ eventId: "started-event", league: "nfl", canonicalBook: "DraftKings", retrievedAt: "2026-01-01T00:00:00.000Z", policyVersion: "policy", offerVersion: "offer", market: "spread", selection: "home", originalOdds: -110, eventStartsAt: "2026-01-02T00:00:00.000Z" }] }]
    };
