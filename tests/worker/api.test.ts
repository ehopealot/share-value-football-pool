...
describe("later wager and member HTTP API", () => {
  ...
  it("replays stored seven-leg teaser bytes before offer reads and rejects fresh seven-leg keys without mutation", async () => {
    ...
    const snapshot = { quoteKey: quoteBody.quoteKey, seasonId: "s1", ownerMemberId: "member", riskMicros: "1000000", acceptedOdds: 860, teaserPoints: 6, rulesetVersion: "TEASER_2026_V2", legs, commandVersion: "5" };
    const placementBody = { wagerId: "legacy-seven", quoteKey: quoteBody.quoteKey, quotedCommandVersion: "5", mutationKey: "legacy-seven-place", commandId: "legacy-seven-place", seasonId: "s1", riskMicros: "1000000", acceptedOdds: 860, teaserPoints: 6, rulesetVersion: "TEASER_2026_V2", legs };
