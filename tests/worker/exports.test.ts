...
describe("member export and encrypted infrastructure backup", () => {
  ...
  it("exports exact audit history while preserving member-level hidden-pick redaction", async () => {
    ...
    await stateFor(poolId, (state) => {
      ...
      INSERT INTO wager_leg (id, wager_id, event_id, league, canonical_book, retrieved_at, policy_version, offer_version, canonical_offer_id, canonical_proof_json, market, selection, original_line, original_odds, teaser_adjustment, adjusted_line, event_starts_at, is_super_bowl, grade, result_version) VALUES ('straight-leg', 'straight-hidden', 'hidden-straight', 'nfl', 'DraftKings', '2026-01-01T00:00:00.000Z', 'policy', 'offer', NULL, NULL, 'spread', 'home', '-3.5', -110, NULL, NULL, '1970-01-01T00:00:00.000Z', 0, 'loss', 'provider-1');
      INSERT INTO wager_leg (id, wager_id, event_id, league, canonical_book, retrieved_at, policy_version, offer_version, canonical_offer_id, canonical_proof_json, market, selection, original_line, original_odds, teaser_adjustment, adjusted_line, event_starts_at, is_super_bowl, grade, result_version) VALUES ('teaser-started', 'teaser-partial', 'revealed-leg', 'nfl', 'DraftKings', '2026-01-01T00:00:00.000Z', 'policy', 'offer', NULL, NULL, 'spread', 'away', '3.5', -110, '6', '9.5', '1970-01-01T00:00:00.000Z', 0, NULL, NULL);
      INSERT INTO wager_leg (id, wager_id, event_id, league, canonical_book, retrieved_at, policy_version, offer_version, canonical_offer_id, canonical_proof_json, market, selection, original_line, original_odds, teaser_adjustment, adjusted_line, event_starts_at, is_super_bowl, grade, result_version) VALUES ('teaser-hidden', 'teaser-partial', 'future-leg', 'ncaaf', 'FanDuel', '2026-01-01T00:00:00.000Z', 'policy', 'offer', NULL, NULL, 'total', 'under', '50.5', -110, '6', '56.5', '${future}', 0, NULL, NULL);
      INSERT INTO wager_leg (id, wager_id, event_id, league, canonical_book, retrieved_at, policy_version, offer_version, canonical_offer_id, canonical_proof_json, market, selection, original_line, original_odds, teaser_adjustment, adjusted_line, event_starts_at, is_super_bowl, grade, result_version) VALUES ('parlay-started-leg', 'parlay-settled', 'parlay-started', 'nfl', 'DraftKings', '2026-01-01T00:00:00.000Z', 'policy', 'offer', NULL, NULL, 'spread', 'home', '-3', 100, NULL, NULL, '1970-01-01T00:00:00.000Z', 0, 'win', 'provider-1');
      INSERT INTO wager_leg (id, wager_id, event_id, league, canonical_book, retrieved_at, policy_version, offer_version, canonical_offer_id, canonical_proof_json, market, selection, original_line, original_odds, teaser_adjustment, adjusted_line, event_starts_at, is_super_bowl, grade, result_version) VALUES ('parlay-future-leg', 'parlay-settled', 'parlay-future', 'ncaaf', 'FanDuel', '2026-01-01T00:00:00.000Z', 'policy', 'offer', NULL, NULL, 'total', 'under', '50.5', -110, NULL, NULL, '${future}', 0, 'win', 'provider-1');
  ...
  it("strictly validates backup keys and stores independently nonce-encrypted self-describing envelopes", async () => {
    ...
    await stateFor(poolId, (state) => state.storage.sql.exec(`
      ...
      INSERT INTO wager_leg (id, wager_id, event_id, league, canonical_book, retrieved_at, policy_version, offer_version, canonical_offer_id, canonical_proof_json, market, selection, original_line, original_odds, teaser_adjustment, adjusted_line, event_starts_at, is_super_bowl, grade, result_version) VALUES ('backup-hidden:z', 'backup-hidden', 'protected-future-z', 'nfl', 'DraftKings', '2026-01-02T00:00:00.000Z', 'policy', 'offer-z', NULL, NULL, 'spread', 'home', '-2.5', -110, '6', '3.5', '2099-01-02T00:00:00.000Z', 0, NULL, NULL);
      INSERT INTO wager_leg (id, wager_id, event_id, league, canonical_book, retrieved_at, policy_version, offer_version, canonical_offer_id, canonical_proof_json, market, selection, original_line, original_odds, teaser_adjustment, adjusted_line, event_starts_at, is_super_bowl, grade, result_version) VALUES ('backup-hidden:a', 'backup-hidden', 'protected-future-a', 'ncaaf', 'FanDuel', '2026-01-02T00:00:00.000Z', 'policy', 'offer-a', NULL, NULL, 'total', 'under', '44.5', -110, '6', '50.5', '2099-01-01T00:00:00.000Z', 0, NULL, NULL);
    ...
    expect(memberExport.wagers).toEqual([{
      wagerId: "backup-hidden", seasonId: "backup-season", memberId: "member", memberDisplayName: "Member", type: "teaser", status: "open", confirmedAt: "2026-01-02T00:00:00.000Z", weekStart: "2098-12-30T08:00:00.000Z", performanceMicros: "0"
    }]);
  ...
  it("fails closed without storing a backup when an accepted wager leg is missing its team snapshot", async () => {
    ...
    await stateFor(poolId, (state) => state.storage.sql.exec(`
      ...
      INSERT INTO wager_leg (id, wager_id, event_id, league, canonical_book, retrieved_at, policy_version, offer_version, canonical_offer_id, canonical_proof_json, market, selection, original_line, original_odds, teaser_adjustment, adjusted_line, event_starts_at, is_super_bowl, grade, result_version) VALUES ('missing-snapshot-leg', 'corrupt-wager', 'missing-snapshot-event', 'nfl', 'DraftKings', '2026-01-02T00:00:00.000Z', 'policy', 'offer', NULL, NULL, 'spread', 'home', '-2.5', -110, NULL, NULL, '2099-01-02T00:00:00.000Z', 0, NULL, NULL);
    `));
